...
|---|---|---|
| `ts/` | @voxgig-sdk/console-weather-forecast-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/console-weather-forecast-sdk \
      --repository voxgig-sdk/console-weather-forecast-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/console-weather-forecast-sdk` shows it, and
`npm trust revoke @voxgig-sdk/console-weather-forecast-sdk --id=<id>` removes it.
