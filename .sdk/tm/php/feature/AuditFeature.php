...
// ConsoleWeatherForecast SDK audit feature
...
class ConsoleWeatherForecastAuditFeature extends ConsoleWeatherForecastBaseFeature
{
    ...
    private function _emit(ConsoleWeatherForecastContext $ctx, string $outcome): void
    {
