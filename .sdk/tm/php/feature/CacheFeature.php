...
// ConsoleWeatherForecast SDK cache feature
...
class ConsoleWeatherForecastCacheFeature extends ConsoleWeatherForecastBaseFeature
{
    ...
    private function _through(ConsoleWeatherForecastContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
