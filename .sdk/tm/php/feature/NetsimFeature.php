...
// ConsoleWeatherForecast SDK netsim feature
...
class ConsoleWeatherForecastNetsimFeature extends ConsoleWeatherForecastBaseFeature
{
    ...
    private function _simulate(ConsoleWeatherForecastContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ConsoleWeatherForecastContext $ctx, array $applied): void
    {
        $client = $this->client;
