...
// ConsoleWeatherForecast SDK proxy feature
...
class ConsoleWeatherForecastProxyFeature extends ConsoleWeatherForecastBaseFeature
{
    ...
    public function init(ConsoleWeatherForecastContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ConsoleWeatherForecastContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
