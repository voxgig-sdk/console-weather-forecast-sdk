...
// ConsoleWeatherForecast SDK ratelimit feature
...
class ConsoleWeatherForecastRatelimitFeature extends ConsoleWeatherForecastBaseFeature
{
    ...
    private function _acquire(ConsoleWeatherForecastContext $ctx): void
    {
    ...
    private function _track(ConsoleWeatherForecastContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
