...
// ConsoleWeatherForecast SDK rbac feature
...
class ConsoleWeatherForecastRbacFeature extends ConsoleWeatherForecastBaseFeature
{
    ...
    private function _required(ConsoleWeatherForecastContext $ctx): ?string
    {
    ...
    private function _reject(ConsoleWeatherForecastContext $ctx, string $required): void
    {
    ...
    private function _track(ConsoleWeatherForecastContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
