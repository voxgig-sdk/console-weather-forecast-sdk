...
// ConsoleWeatherForecast SDK timeout feature
...
class ConsoleWeatherForecastTimeoutFeature extends ConsoleWeatherForecastBaseFeature
{
    ...
    private function _with_timeout(ConsoleWeatherForecastContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ConsoleWeatherForecastContext $_ctx, float $ms): void
    {
        $client = $this->client;
