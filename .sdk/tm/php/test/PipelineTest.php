...
// ConsoleWeatherForecast SDK pipeline test
//
...
{
    private static function utility(): ConsoleWeatherForecastUtility
    {
        return new ConsoleWeatherForecastUtility();
    }
    ...
    private static function ctx(array $over = []): ConsoleWeatherForecastContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new ConsoleWeatherForecastContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new ConsoleWeatherForecastOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof ConsoleWeatherForecastError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new ConsoleWeatherForecastOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = ConsoleWeatherForecastMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new ConsoleWeatherForecastOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = ConsoleWeatherForecastMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new ConsoleWeatherForecastOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = ConsoleWeatherForecastMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ConsoleWeatherForecastSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = ConsoleWeatherForecastMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new ConsoleWeatherForecastResponse([]),
            'result' => new ConsoleWeatherForecastResult([]),
        ]);
        [, $err] = ConsoleWeatherForecastMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new ConsoleWeatherForecastSpec([]),
            'response' => null,
            'result' => new ConsoleWeatherForecastResult([]),
        ]);
        [, $err] = ConsoleWeatherForecastMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new ConsoleWeatherForecastSpec(['step' => 's']),
            'response' => new ConsoleWeatherForecastResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new ConsoleWeatherForecastResult([]),
        ]);
        [, $err] = ConsoleWeatherForecastMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new ConsoleWeatherForecastSpec(['step' => 's']),
            'response' => new ConsoleWeatherForecastResponse(self::resp(200, ['v' => 1])),
            'result' => new ConsoleWeatherForecastResult([]),
        ]);
        [, $err] = ConsoleWeatherForecastMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new ConsoleWeatherForecastSpec(['step' => 's']),
            'response' => new ConsoleWeatherForecastResponse(self::resp(200, ['v' => 2])),
            'result' => new ConsoleWeatherForecastResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        ConsoleWeatherForecastMakeResponse::call($ctx);
    ...
    {
        $preset = new ConsoleWeatherForecastResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new ConsoleWeatherForecastSpec([]),
            'response' => new ConsoleWeatherForecastResponse([]),
            'result' => new ConsoleWeatherForecastResult([]),
        ...
        [$got, $err] = ConsoleWeatherForecastMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new ConsoleWeatherForecastResult([])]);
        [, $err] = ConsoleWeatherForecastMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new ConsoleWeatherForecastSpec([]), 'result' => null]);
        [, $err] = ConsoleWeatherForecastMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ConsoleWeatherForecastSpec(['step' => 's']),
            'result' => new ConsoleWeatherForecastResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new ConsoleWeatherForecastOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ConsoleWeatherForecastMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ConsoleWeatherForecastSpec(['step' => 's']),
            'result' => new ConsoleWeatherForecastResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new ConsoleWeatherForecastOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ConsoleWeatherForecastMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ConsoleWeatherForecastResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new ConsoleWeatherForecastSpec([]),
            'result' => new ConsoleWeatherForecastResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = ConsoleWeatherForecastMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ConsoleWeatherForecastMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new ConsoleWeatherForecastError('boom', 'boom');
        $utility->fetcher = function (ConsoleWeatherForecastContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ConsoleWeatherForecastSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = ConsoleWeatherForecastMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (ConsoleWeatherForecastContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = ConsoleWeatherForecastMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(ConsoleWeatherForecastResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        ConsoleWeatherForecastMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (ConsoleWeatherForecastContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ConsoleWeatherForecastSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = ConsoleWeatherForecastMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new ConsoleWeatherForecastResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new ConsoleWeatherForecastSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = ConsoleWeatherForecastMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = ConsoleWeatherForecastMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = ConsoleWeatherForecastMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new ConsoleWeatherForecastResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, ConsoleWeatherForecastDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new ConsoleWeatherForecastResult(['ok' => false])]);
        $this->expectException(ConsoleWeatherForecastError::class);
        ConsoleWeatherForecastDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new ConsoleWeatherForecastResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', ConsoleWeatherForecastMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        ConsoleWeatherForecastMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new ConsoleWeatherForecastBaseFeature();
        $b = new ConsoleWeatherForecastBaseFeature();
        ConsoleWeatherForecastFeatureAdd::call($ctx, $a);
        ConsoleWeatherForecastFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): ConsoleWeatherForecastBaseFeature
    {
        $f = new ConsoleWeatherForecastBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        ConsoleWeatherForecastFeatureAdd::call($ctx, self::named_feature('a'));
        ConsoleWeatherForecastFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        ConsoleWeatherForecastFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        ConsoleWeatherForecastFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        ConsoleWeatherForecastFeatureAdd::call($ctx, $replace);
        ...
        ConsoleWeatherForecastFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): ConsoleWeatherForecastContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new ConsoleWeatherForecastSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ConsoleWeatherForecastPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        ConsoleWeatherForecastPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new ConsoleWeatherForecastResponse(['headers' => null]),
            'result' => new ConsoleWeatherForecastResult([]),
        ]);
        ConsoleWeatherForecastResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        ConsoleWeatherForecastResultBody::call($ctx);
