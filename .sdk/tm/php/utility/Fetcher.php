...
// ConsoleWeatherForecast SDK utility: fetcher

class ConsoleWeatherForecastFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ConsoleWeatherForecastSDK/1.0)';
    ...
    public static function call(ConsoleWeatherForecastContext $ctx, string $fullurl, array $fetchdef): array
    {
