...
// ConsoleWeatherForecast SDK utility: make_spec

require_once __DIR__ . '/Graphql.php';

require_once __DIR__ . '/../core/Spec.php';

class ConsoleWeatherForecastMakeSpec
{
    public static function call(ConsoleWeatherForecastContext $ctx): array
    {
        ...
        if ('graphql' === \Voxgig\Struct\Struct::getprop($point, 'kind')) {
            ...
            $ctx->spec->query = [];
            $ctx->spec->headers['content-type'] = ConsoleWeatherForecastGraphql::CONTENT_TYPE;
        } else {
