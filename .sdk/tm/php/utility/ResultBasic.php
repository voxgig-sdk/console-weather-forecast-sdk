...
// ConsoleWeatherForecast SDK utility: result_basic

class ConsoleWeatherForecastResultBasic
{
    public static function call(ConsoleWeatherForecastContext $ctx): ?ConsoleWeatherForecastResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof ConsoleWeatherForecastError) ? $result->err->msg : (string)$result->err;
