# ConsoleWeatherForecast SDK feature corpus test
#
...
def _client(kase):
    ...
    ConsoleWeatherForecastSDK(...), not ConsoleWeatherForecastSDK.test(...): the `test` feature is
    ...
    return ConsoleWeatherForecastSDK(opts)
