...
AQL-driven CLI and REPL for the ConsoleWeatherForecast SDK. Positional arguments are
...
```sh
go build -o console-weather-forecast-cli ./...
```
...
./console-weather-forecast-cli list get_current_location_weather
./console-weather-forecast-cli load 1 get_current_location_weather
./console-weather-forecast-cli load '{id:1}' get_current_location_weather
