...
AQL-driven command-line client **and** interactive REPL for the ConsoleWeatherForecast
...
- `<entity>` is a bareword, auto-quoted as an AQL atom (e.g. `get_current_location_weather`).
