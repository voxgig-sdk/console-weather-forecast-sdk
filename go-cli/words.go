...
func registerSDKWords(r *eng.Registry, client *sdk.ConsoleWeatherForecastSDK) {
...
func runOp(client *sdk.ConsoleWeatherForecastSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
