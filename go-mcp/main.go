// Command ConsoleWeatherForecast-mcp is an MCP server exposing the ConsoleWeatherForecast
// SDK as MCP tools.
//
// Two tools are registered:
//
//	ConsoleWeatherForecast_list  — list records of an entity
//	ConsoleWeatherForecast_load  — load a single record of an entity
//
