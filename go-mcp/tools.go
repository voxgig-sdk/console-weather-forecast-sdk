...
type Args struct {
	Entity string         `json:"entity" jsonschema:"get_current_location_weather | get_location_weather | help | location"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.ConsoleWeatherForecastSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "console-weather-forecast_list",
		Description: "List records from ConsoleWeatherForecast. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "console-weather-forecast_load",
		Description: "Load a single record from ConsoleWeatherForecast. " +
...
func runOp(client *sdk.ConsoleWeatherForecastSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ConsoleWeatherForecastSDK, name string) (sdk.ConsoleWeatherForecastEntity, error) {
	switch strings.ToLower(name) {
	case "get_current_location_weather":
		return client.GetCurrentLocationWeather(nil), nil
	case "get_location_weather":
		return client.GetLocationWeather(nil), nil
	case "help":
		return client.Help(nil), nil
	case "location":
