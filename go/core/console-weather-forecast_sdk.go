...
type ConsoleWeatherForecastSDK struct {
	Mode     string
...
func (sdk *ConsoleWeatherForecastSDK) OptionsMap() map[string]any {
...
func (sdk *ConsoleWeatherForecastSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *ConsoleWeatherForecastSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *ConsoleWeatherForecastSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ConsoleWeatherForecastSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *ConsoleWeatherForecastSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *ConsoleWeatherForecastSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("ConsoleWeatherForecastSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *ConsoleWeatherForecastSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ConsoleWeatherForecastSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("ConsoleWeatherForecastSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *ConsoleWeatherForecastSDK {
	...
	sdk := NewConsoleWeatherForecastSDK(sdkopts)
	sdk.Mode = "test"
