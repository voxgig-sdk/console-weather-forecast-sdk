...
type GetLocationWeatherEntity struct {
	name    string
...
func NewGetLocationWeatherEntity(client *core.ConsoleWeatherForecastSDK, entopts map[string]any) *GetLocationWeatherEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetLocationWeatherEntity) GetName() string { return e.name }
...
func (e *GetLocationWeatherEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetLocationWeatherEntity) Deleted() bool {
	return e.deleted
}


func (e *GetLocationWeatherEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetLocationWeatherEntity(e.client, opts)
}

func (e *GetLocationWeatherEntity) Data(args ...any) any {
...
func (e *GetLocationWeatherEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GetLocationWeather; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GetLocationWeatherEntity) DataTyped(data ...GetLocationWeather) GetLocationWeather {
	if len(data) > 0 {
		return typedFrom[GetLocationWeather](e.Data(asMap(data[0])))
	}
	return typedFrom[GetLocationWeather](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GetLocationWeather (all fields
// optional at the wire level).
func (e *GetLocationWeatherEntity) MatchTyped(match ...GetLocationWeather) GetLocationWeather {
	if len(match) > 0 {
		return typedFrom[GetLocationWeather](e.Match(asMap(match[0])))
	}
	return typedFrom[GetLocationWeather](e.Match())
}
...
func (e *GetLocationWeatherEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetLocationWeatherEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GetLocationWeatherLoadMatch and returns an GetLocationWeather. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GetLocationWeatherEntity) LoadTyped(reqmatch GetLocationWeatherLoadMatch, ctrl map[string]any) (GetLocationWeather, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GetLocationWeather{}, err
	}
	return typedFrom[GetLocationWeather](res), nil
}



func (e *GetLocationWeatherEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GetLocationWeatherEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetLocationWeatherEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetLocationWeatherEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetLocationWeatherEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
