...
func NewHelpEntity(client *core.ConsoleWeatherForecastSDK, entopts map[string]any) *HelpEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *HelpEntity) GetName() string { return e.name }
...
func (e *HelpEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *HelpEntity) Deleted() bool {
	return e.deleted
}


func (e *HelpEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewHelpEntity(e.client, opts)
}

func (e *HelpEntity) Data(args ...any) any {
...
func (e *HelpEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Help; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *HelpEntity) DataTyped(data ...Help) Help {
	if len(data) > 0 {
		return typedFrom[Help](e.Data(asMap(data[0])))
	}
	return typedFrom[Help](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Help (all fields
// optional at the wire level).
func (e *HelpEntity) MatchTyped(match ...Help) Help {
	if len(match) > 0 {
		return typedFrom[Help](e.Match(asMap(match[0])))
	}
	return typedFrom[Help](e.Match())
}
...
func (e *HelpEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *HelpEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// HelpLoadMatch and returns an Help. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *HelpEntity) LoadTyped(reqmatch HelpLoadMatch, ctrl map[string]any) (Help, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Help{}, err
	}
	return typedFrom[Help](res), nil
}



func (e *HelpEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *HelpEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *HelpEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *HelpEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *HelpEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
