...
const testSeed = `map[string]any{"entity": map[string]any{"get_current_location_weather": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "get_location_weather": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "help": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "location": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
