...
local GetCurrentLocationWeatherEntity = {}
GetCurrentLocationWeatherEntity.__index = GetCurrentLocationWeatherEntity


function GetCurrentLocationWeatherEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetCurrentLocationWeatherEntity)
  self._name = "get_current_location_weather"
  self._client = client
...
function GetCurrentLocationWeatherEntity:get_name()
  return self._name
end


function GetCurrentLocationWeatherEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetCurrentLocationWeatherEntity.new(self._client, opts)
end
...
function GetCurrentLocationWeatherEntity:mark_deleted()
  self._deleted = true
end


function GetCurrentLocationWeatherEntity:deleted()
  return true == self._deleted
end


function GetCurrentLocationWeatherEntity:data_set(args)
  if args ~= nil then
...
function GetCurrentLocationWeatherEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetCurrentLocationWeatherEntity:match_set(args)
  if args ~= nil then
...
function GetCurrentLocationWeatherEntity:match_get()
...
function GetCurrentLocationWeatherEntity:stream(action, args, callopts)
...
---@param reqmatch GetCurrentLocationWeatherLoadMatch
---@param ctrl? table
---@return GetCurrentLocationWeather
---@return string? err
function GetCurrentLocationWeatherEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function GetCurrentLocationWeatherEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return GetCurrentLocationWeatherEntity
