...
local GetLocationWeatherEntity = {}
GetLocationWeatherEntity.__index = GetLocationWeatherEntity


function GetLocationWeatherEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetLocationWeatherEntity)
  self._name = "get_location_weather"
  self._client = client
...
function GetLocationWeatherEntity:get_name()
  return self._name
end


function GetLocationWeatherEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetLocationWeatherEntity.new(self._client, opts)
end
...
function GetLocationWeatherEntity:mark_deleted()
  self._deleted = true
end


function GetLocationWeatherEntity:deleted()
  return true == self._deleted
end


function GetLocationWeatherEntity:data_set(args)
  if args ~= nil then
...
function GetLocationWeatherEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetLocationWeatherEntity:match_set(args)
  if args ~= nil then
...
function GetLocationWeatherEntity:match_get()
...
function GetLocationWeatherEntity:stream(action, args, callopts)
...
---@param reqmatch GetLocationWeatherLoadMatch
---@param ctrl? table
---@return GetLocationWeather
---@return string? err
function GetLocationWeatherEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function GetLocationWeatherEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return GetLocationWeatherEntity
