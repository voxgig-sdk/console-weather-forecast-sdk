...
describe("HelpDirect", function()
  it("should direct-load-help", function()
    local setup = help_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-help", setup.live and "live" or "unit")
...
function help_direct_setup(mockres)
