...
local SDK_MODULE = "console-weather-forecast_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["get_current_location_weather"] = { ["test01"] = { id = "test01" } }, ["get_location_weather"] = { ["test01"] = { id = "test01" } }, ["help"] = { ["test01"] = { id = "test01" } }, ["location"] = { ["test01"] = { id = "test01" } } } }'
