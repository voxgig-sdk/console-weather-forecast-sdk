...
function runner.env_override(m)
  local live = runner.getenv("CONSOLEWEATHERFORECAST_TEST_LIVE")
  local override = runner.getenv("CONSOLEWEATHERFORECAST_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("CONSOLEWEATHERFORECAST_TEST_EXPLAIN")
