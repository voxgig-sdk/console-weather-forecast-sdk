...
function runner.env_override(m)
  local live = runner.getenv("CONSOLE_WEATHER_FORECAST_TEST_LIVE")
  local override = runner.getenv("CONSOLE_WEATHER_FORECAST_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("CONSOLE_WEATHER_FORECAST_TEST_EXPLAIN")
