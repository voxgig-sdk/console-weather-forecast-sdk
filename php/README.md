...
The PHP SDK for the ConsoleWeatherForecast API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->GetCurrentLocationWeather(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->ConsoleWeatherForecast(null)->load(
    ["id" => "test01"], null
);
