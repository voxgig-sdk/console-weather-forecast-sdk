# ConsoleWeatherForecast PHP SDK



The PHP SDK for the ConsoleWeatherForecast API — an entity-oriented client using PHP conventions.
...
try {
    ...
    print_r($getcurrentlocationweather->data_get());
} catch (\Throwable $err) {
...
print_r($getlocationweather->data_get());
```
...
```
php/
├── consoleweatherforecast_sdk.php          -- Main SDK class
...
The main class (`consoleweatherforecast_sdk.php`) exports the SDK class
