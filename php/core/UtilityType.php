...
// ConsoleWeatherForecast SDK utility type

class ConsoleWeatherForecastUtility
{
    ...
    public static function copy(ConsoleWeatherForecastUtility $src): ConsoleWeatherForecastUtility
    {
        $u = new ConsoleWeatherForecastUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
