...
// ConsoleWeatherForecast SDK Help entity
...
class HelpEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new HelpEntity($this->_client, $opts);
    }

    /**
     * @param Help|array $args Help data (assoc-array) to store.
     */
    ...
    /**
     * @return Help|array The current Help data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Help fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Help fields).
     */
     ...
     * Load a single Help.
     *
     * @param HelpLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed HelpLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Help|array The loaded Help as an assoc-array at the
