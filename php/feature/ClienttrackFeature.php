...
// ConsoleWeatherForecast SDK clienttrack feature
...
class ConsoleWeatherForecastClienttrackFeature extends ConsoleWeatherForecastBaseFeature
{
    ...
    public function PostConstruct(ConsoleWeatherForecastContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'ConsoleWeatherForecast-SDK';
