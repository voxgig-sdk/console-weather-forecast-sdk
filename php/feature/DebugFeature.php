...
// ConsoleWeatherForecast SDK debug feature
...
class ConsoleWeatherForecastDebugFeature extends ConsoleWeatherForecastBaseFeature
{
    ...
    private function _finish(ConsoleWeatherForecastContext $ctx, bool $ok): void
    {
