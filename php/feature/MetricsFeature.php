...
// ConsoleWeatherForecast SDK metrics feature
...
class ConsoleWeatherForecastMetricsFeature extends ConsoleWeatherForecastBaseFeature
{
    ...
    private function _record(ConsoleWeatherForecastContext $ctx, bool $ok): void
    {
