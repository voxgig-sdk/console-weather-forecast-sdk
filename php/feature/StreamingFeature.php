...
// ConsoleWeatherForecast SDK streaming feature
...
class ConsoleWeatherForecastStreamingFeature extends ConsoleWeatherForecastBaseFeature
{
    ...
    private function _iterate(ConsoleWeatherForecastResult $result): \Generator
    {
    ...
    private function _streamable(ConsoleWeatherForecastContext $ctx): bool
    {
