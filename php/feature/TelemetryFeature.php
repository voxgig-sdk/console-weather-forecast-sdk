...
// ConsoleWeatherForecast SDK telemetry feature
...
class ConsoleWeatherForecastTelemetryFeature extends ConsoleWeatherForecastBaseFeature
{
    ...
    private function _close(ConsoleWeatherForecastContext $ctx, bool $ok): void
    {
