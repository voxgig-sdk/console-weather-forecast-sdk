...
class GetLocationWeatherDirectTest extends TestCase
{
    public function test_direct_load_get_location_weather(): void
    {
        $setup = get_location_weather_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-get_location_weather", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
