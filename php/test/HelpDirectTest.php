...
class HelpDirectTest extends TestCase
{
    public function test_direct_load_help(): void
    {
        $setup = help_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-help", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
