...
// ConsoleWeatherForecast SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ConsoleWeatherForecastSDK::test)
...
{
    private const SDK_CLASS = 'ConsoleWeatherForecastSDK';
    ...
    private const SDK_BASE = 'consoleweatherforecast_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../consoleweatherforecast_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
