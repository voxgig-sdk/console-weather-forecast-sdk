...
// ConsoleWeatherForecast SDK utility: graphql
//
...
class ConsoleWeatherForecastGraphql
{
    ...
    // equivalent.
    public static function body(ConsoleWeatherForecastContext $ctx): mixed
    {
    ...
    public static function errors(ConsoleWeatherForecastContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
