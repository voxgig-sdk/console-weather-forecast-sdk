...
// ConsoleWeatherForecast SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ConsoleWeatherForecastMakeRequest
{
    public static function call(ConsoleWeatherForecastContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ConsoleWeatherForecastResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ConsoleWeatherForecastResponse($fetched);
        } else {
