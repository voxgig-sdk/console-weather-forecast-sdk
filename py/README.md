# ConsoleWeatherForecast Python SDK



The Python SDK for the ConsoleWeatherForecast API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.GetCurrentLocationWeather()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/console-weather-forecast-sdk/releases)) or
...
```
py/
├── consoleweatherforecast_sdk.py         -- Main SDK module
