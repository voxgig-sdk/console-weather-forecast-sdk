...
from consoleweatherforecast_sdk.utility import register

# Load features
from consoleweatherforecast_sdk.feature.base_feature import ConsoleWeatherForecastBaseFeature
from consoleweatherforecast_sdk.features import _has_feature, _make_feature
...
class ConsoleWeatherForecastSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = ConsoleWeatherForecastUtility()
        self._utility = utility

        from consoleweatherforecast_sdk.config import shared_config
    ...
    def get_utility(self):
        return ConsoleWeatherForecastUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ConsoleWeatherForecastSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def GetCurrentLocationWeather(self, data=None) -> "GetCurrentLocationWeatherEntity":
        ...
        from consoleweatherforecast_sdk.entity.get_current_location_weather_entity import GetCurrentLocationWeatherEntity
    ...
    def GetLocationWeather(self, data=None) -> "GetLocationWeatherEntity":
        ...
        from consoleweatherforecast_sdk.entity.get_location_weather_entity import GetLocationWeatherEntity
    ...
    def Help(self, data=None) -> "HelpEntity":
        ...
        from consoleweatherforecast_sdk.entity.help_entity import HelpEntity
    ...
    def Location(self, data=None) -> "LocationEntity":
        ...
        from consoleweatherforecast_sdk.entity.location_entity import LocationEntity
