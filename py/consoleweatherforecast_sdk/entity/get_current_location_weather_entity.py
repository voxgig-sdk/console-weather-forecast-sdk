...
from consoleweatherforecast_sdk.consoleweatherforecast_types import (
...
class GetCurrentLocationWeatherEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetCurrentLocationWeatherEntity(self._client, opts)
    ...
    def data_get(self) -> GetCurrentLocationWeather:
    ...
    def match_get(self) -> GetCurrentLocationWeather:
    ...
    def load(self, reqmatch=None, ctrl=None) -> GetCurrentLocationWeather:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.GetCurrentLocationWeather().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
