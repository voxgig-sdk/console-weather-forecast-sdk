# ConsoleWeatherForecast SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ConsoleWeatherForecastSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ConsoleWeatherForecastSDK(...) and ConsoleWeatherForecastSDK.test(...) become
#      ConsoleWeatherForecastSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "consoleweatherforecast_sdk"
_SDK_CLASS = "ConsoleWeatherForecastSDK"
...
_ENTITIES = {
    "GetCurrentLocationWeather": "get_current_location_weather",
    "GetLocationWeather": "get_location_weather",
    "Help": "help",
    "Location": "location",
}
