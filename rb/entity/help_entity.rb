...
class HelpEntity
  ...
  # @return [Help, Hash] the current Help data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Help fields)
  def match_get
  ...
  # Load a single Help.
  #
  # @param reqmatch [HelpLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Help.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Help, Hash] the loaded Help; raises ConsoleWeatherForecastError on failure
