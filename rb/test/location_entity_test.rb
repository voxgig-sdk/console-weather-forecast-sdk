...
class LocationEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set CONSOLE_WEATHER_FORECAST_TEST_LOCATION_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def location_basic_setup(extra)
  ...
  entid_env_raw = ENV["CONSOLE_WEATHER_FORECAST_TEST_LOCATION_ENTID"]
