...
class LocationEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set CONSOLEWEATHERFORECAST_TEST_LOCATION_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def location_basic_setup(extra)
  ...
  entid_env_raw = ENV["CONSOLEWEATHERFORECAST_TEST_LOCATION_ENTID"]
