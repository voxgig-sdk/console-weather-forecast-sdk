...
#      offline in seeded test mode (ConsoleWeatherForecastSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "ConsoleWeatherForecast_sdk.rb")
  SDK_CLASS = "ConsoleWeatherForecastSDK"
  ...
  SDK_BASE = "ConsoleWeatherForecast_sdk"
