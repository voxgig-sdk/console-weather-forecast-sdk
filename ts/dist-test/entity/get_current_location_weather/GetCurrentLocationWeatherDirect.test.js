...
(0, node_test_1.describe)('GetCurrentLocationWeatherDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.ConsoleWeatherForecastSDK({
    ...
    (0, node_test_1.test)('direct-load-get_current_location_weather', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-get_current_location_weather', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.CONSOLE_WEATHER_FORECAST_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.ConsoleWeatherForecastSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['CONSOLE_WEATHER_FORECAST_TEST_GET_CURRENT_LOCATION_WEATHER_ENTID'];
    ...
    const client = new __1.ConsoleWeatherForecastSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GetCurrentLocationWeatherDirect.test.js.map