...
(0, node_test_1.describe)('HelpDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-help', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-help', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CONSOLE_WEATHER_FORECAST_TEST_HELP_ENTID'];
...
//# sourceMappingURL=HelpDirect.test.js.map