...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/help/HelpTestData.json');
    ...
    let idmap = transform(['help01', 'help02', 'help03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    if (live) {
        const rawIds = process.env['CONSOLE_WEATHER_FORECAST_TEST_HELP_ENTID'];
...
//# sourceMappingURL=HelpEntity.test.js.map