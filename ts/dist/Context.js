...
const ConsoleWeatherForecastError_1 = require("./ConsoleWeatherForecastError");
...
class Context {
    ...
    error(code, msg) {
        return new ConsoleWeatherForecastError_1.ConsoleWeatherForecastError(code, msg, this);
    }
    toJSON() {
        return {
            id: this.id,
